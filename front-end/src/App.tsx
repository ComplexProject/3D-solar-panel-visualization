  ...
  return (
    <>
      <div className='h-screen w-full bg-red-50'>
        <div ref={pullTabRef} className={`absolute z-30 right-0 top-11 h-24 flex items-center px-5 bg-[#F8F8F8] rounded-l-4xl drop-shadow cursor-pointer transition-all duration-150
        ...
        <div className='relative h-screen w-full bg-red-50'>
          <ModelViewer>
