export async function sendFormData() {
    ...
    const savedAzimuthIncrement = JSON.parse(localStorage.getItem("azimuthIncrement") || "5");
    const savedSlopeIncrement = JSON.parse(localStorage.getItem("slopeIncrement") || "2");
    ...
    formData.append('azimuthIncrement', savedAzimuthIncrement.toString());
    formData.append('slopeIncrement', savedSlopeIncrement.toString());
